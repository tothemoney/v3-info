...
import { CeloNetworkInfo, PolygonNetworkInfo, SUPPORTED_NETWORK_VERSIONS, TmyNetworkInfo } from 'constants/networks'
    ...
    <Container ref={node}>
      <Wrapper onClick={() => setShowMenu(!showMenu)}>
        <RowFixed>
          ...
          {[EthereumNetworkInfo, PolygonNetworkInfo, CeloNetworkInfo, TmyNetworkInfo].includes(activeNetwork) ? null : (
